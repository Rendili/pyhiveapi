            ...
            for product in HSC.products.sensors:
                if ("id" in product and "state" in product and "name" in product["state"]):
                    if "type" in product:
                        ...
                        if hive_sensor_device_type == 'motionsensor':
                            device_list_binary_sensor.append({'HA_DeviceType': 'Hive_Device_Motion_Sensor', 'Hive_NodeID': product["id"], 'Hive_NodeName': product["state"]["name"], "Hive_DeviceType": hive_sensor_device_type})
                        if hive_sensor_device_type == 'contactsensor':
                            device_list_binary_sensor.append({'HA_DeviceType': 'Hive_Device_Contact_Sensor', 'Hive_NodeID': product["id"], 'Hive_NodeName': product["state"]["name"], "Hive_DeviceType": hive_sensor_device_type})
